    ...
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(a) {
            if (a.getState() === "SUCCESS") {
                ...
                component.set("v.selectedContact", a.getReturnValue().AcctSeed__Billing_Contact__c);
                component.set("v.selectedBillingContact", a.getReturnValue().AcctSeed__Billing_Contact__c);
            }
        });
        ...
        var action2 = component.get("c.getCurrentPolicy");
        action2.setParams({
            accountId : component.get("v.recordId")
        });
    ...
    saveContact: function(component, event, helper) {
        ...
        if(whichContact == 'policyContact'){
            action1.setParams({
                ...
                "policyId" : component.get("v.record.Id")
            });
        }else{
