	...
	init: function(component, event) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                var allClaimsRows = results.claims;
                ...
                RowItemList.sort(function(a,b){
                    return new Date(b.Report_Date__c) - new Date(a.Report_Date__c);
                });
                
                console.log('RowItemList => ',RowItemList);
                component.set("v.ClaimList", RowItemList);
                component.set("v.contact", results.recName);
